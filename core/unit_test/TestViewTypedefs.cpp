...
#if defined(KOKKOS_ENABLE_CUDA_UVM) || defined(KOKKOS_ENABLE_IMPL_CUDA_UNIFIED_MEMORY) || defined(KOKKOS_ENABLE_IMPL_HIP_UNIFIED_MEMORY) || defined(KOKKOS_ENABLE_IMPL_NEXTSILICON_UNIFIED_MEMORY)
