...
#ifndef KOKKOS_NEXTSILICON_SCHEDULE_TYPE_HPP
#define KOKKOS_NEXTSILICON_SCHEDULE_TYPE_HPP
...
using NextSiliconScheduleType = typename NextSiliconSchedule<Policy>::type;

}  // namespace Kokkos::Experimental::Impl

#endif  // KOKKOS_NEXTSILICON_SCHEDULE_TYPE_HPP
